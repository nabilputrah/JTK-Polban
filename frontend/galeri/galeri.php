...
<head>
  ...
  <title>Galeri | Politeknik Negeri Bandung</title>
...
<body>
  ...
  <section id="hero" style="background-attachment: relative;" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1 id="judul_utama" class="d-flex justify-content-center">Daftar<span>&nbspGaleri</span></h1>
    </div>
  </section><!-- End Slider -->
