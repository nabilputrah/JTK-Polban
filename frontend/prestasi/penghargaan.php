                            ...
                            <div class="container" data-aos="fade-up">
                                ...
                                <div class="row" style="margin-left: -5%;">
                                  <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                                    <img id="penghargaan1_img" src="../assets/img/daftarprestasi/maprespolban.jpg" class="img-fluid" alt="" width="100%">
                                  </div>
                                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                                      <div class="section-title">
                                          <h4 id="penghargaan1_judul"></h4>
                                        <h5>Prestasi</h5>
                                        <h5 class="author"><span id="penghargaan1_author"></span> | <span id="penghargaan1_published"></span></h5>
                                        <a href="#" id="penghargaan1_href"> <h5 class="readmore"><b><u>Baca Selengkapnya</u></b></h5></a>
                                      </div>   
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-left: -5%;">
                                  <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                                    <img id="penghargaan2_img" src="../assets/img/daftarprestasi/maprespolban.jpg" class="img-fluid" alt="" width="100%">
                                  </div>
                                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                                      <div class="section-title">
                                          <h4 id="penghargaan2_judul"></h4>
                                        <h5>Prestasi</h5>
                                        <h5 class="author"><span id="penghargaan2_author"></span> | <span id="penghargaan2_published"></span></h5>
                                        <a href="#" id="penghargaan2_href"> <h5 class="readmore"><b><u>Baca Selengkapnya</u></b></h5></a>
                                      </div>   
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-left: -5%;">
                                  <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                                    <img id="penghargaan3_img" src="../assets/img/daftarprestasi/maprespolban.jpg" class="img-fluid" alt="" width="100%">
                                  </div>
                                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                                      <div class="section-title">
                                          <h4 id="penghargaan3_judul"></h4>
                                        <h5>Prestasi</h5>
                                        <h5 class="author"><span id="penghargaan3_author"></span> | <span id="penghargaan3_published"></span></h5>
                                        <a href="#" id="penghargaan3_href"> <h5 class="readmore"><b><u>Baca Selengkapnya</u></b></h5></a>
                                      </div>   
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-left: -5%;">
                                  <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                                    <img id="penghargaan4_img" src="../assets/img/daftarprestasi/maprespolban.jpg" class="img-fluid" alt="" width="100%">
                                  </div>
                                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                                      <div class="section-title">
                                          <h4 id="penghargaan4_judul"></h4>
                                        <h5>Prestasi</h5>
                                        <h5 class="author"><span id="penghargaan4_author"></span> | <span id="penghargaan4_published"></span></h5>
                                        <a href="#" id="penghargaan4_href"> <h5 class="readmore"><b><u>Baca Selengkapnya</u></b></h5></a>
                                      </div>   
                                    </div>
                                </div>    
                  ...
                  <aside class="mu-sidebar">
                    ...
                    <div class="mu-single-sidebar">
                      ...
                      <ul class="mu-sidebar-catg" style="list-style: none;">
                        <li><a href="mahasiswa-berprestasi.php">Mahasiswa Berprestasi</a></li>
                        <li><a style="border-left: 6px solid #105194;" href="penghargaan.php">Penghargaan</a></li>
                        <li><a href="program-kreativitas-mahasiswa.php">Program Kreativitas Mahasiswa</a></li>
                      </ul>
                    </div>
...
<script type="text/javascript">
  ...
  function formatMyDate(value, locale = 'en-GB') {
	...
	async function arsip_kerjasama() {
	    // fetch data
      let response = await fetch(web_strapi + '/prestasis/indexpenghargaan');
      ...
      for (i; i <= 4; i++) {
        console.log(data);
        document.getElementById("penghargaan"+ i +"_judul").innerHTML = data[i-1].judul;
        document.getElementById("penghargaan"+ i +"_author").innerHTML = data[i-1].Author;
        document.getElementById("penghargaan"+ i +"_published").innerHTML = formatMyDate(data[i-1].published_at);
        document.getElementById("penghargaan"+ i +"_href").href = "prestasi-detail.php?id=" + data[i-1].slug;
        document.getElementById("penghargaan"+ i +"_img").src = web_strapi + data[i-1].attachment.url;
