...
<body>
  ...
  <section id="hero" style="background-attachment: relative;" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1 class="d-flex justify-content-center">Detail<span>&nbsp;Kerja Sama</span></h1>
    </div>
  </section><!-- End Slider -->
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Detail Kerja Sama</h2>
          <ol>
            <li><a href="../index.php">Beranda</a></li>
            <li>Mitra</li>
            <li>Arsip Kerja Sama </li>
            <li id="ks_title">:title</li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                  <img src="../assets/img/portfolio/portfolio-details-1.jpg" id="kerjasama_img" alt="">
              </div>
...
<script type="text/javascript">
  ...
  async function berita() {
      // fetch data
      let response = await fetch(web_strapi + '/arsipkerjasamas/' + id);
