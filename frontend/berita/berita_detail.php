...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link" href="#">Tentang JTK</a></li>
          <li><a class="nav-link" href="#">Akademik</a></li>
          <li><a class="nav-link" href="#">Mitra</a></li>
          <li><a class="nav-link" href="#">Lulusan</a></li>
  ...
  <section id="hero" style="background-attachment: relative;" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1 class="d-flex justify-content-center">Detail<span>&nbsp;Berita</span></h1>
    </div>
  </section><!-- End Slider -->
...
<script type="text/javascript">
  ...
  async function berita() {
      ...
      document.getElementById("berita_text").innerHTML = data.deskripsi;
